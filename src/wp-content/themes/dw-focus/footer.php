...
?>
    ...
    <footer id="colophon" class="site-footer dark" role="contentinfo">
        <div class="container">
            ...
            <div id="site-tools">
                <div class="row">
                    ...
                    <div class="span3"><a href="#" class="footer-toggle pull-right">Menu inferior</a></div>
                    <?php } ?>
                </div>
            </div>
        ...
        <div id="site-info" class="container">
            <div class="clearfix">
                <div class="copyright">
                    <p>Geral na Saúde, <?php echo date('Y') ?>. Todos os direitos reservados.</p>
                </div>
               <!-- <div class="logo">
...
<a class="scroll-top" href="#masthead" title="Voltar ao topo">Topo<a>
